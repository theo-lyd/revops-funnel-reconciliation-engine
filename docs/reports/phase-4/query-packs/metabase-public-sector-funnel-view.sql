-- Metabase query pack: Public-Sector Funnel View
-- Purpose: Standard KPI query for public-sector and executive governance reporting.

with base as (
    select *
    from analytics_gold.bi_public_sector_executive_overview
)
